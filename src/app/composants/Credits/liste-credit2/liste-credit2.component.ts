...
@Component({
  selector: 'app-liste-credit2',
  templateUrl: './liste-credit2.component.html',
  styleUrls: ['./liste-credit2.component.css']
})
export class ListeCredit2Component {
  ...
  this.credit_service.get_credits().subscribe(
    {
      ...
      next:(res)=>{
        ...
        res.forEach(element => {
          if(element.loan_type=='Formule 2'){
