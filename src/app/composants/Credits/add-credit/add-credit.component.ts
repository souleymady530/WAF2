...
export class AddCreditComponent {
 ...
 lastFormGroup=this.form_builder.group({ is_all_valide: [null,[]]});
   ...
   // app_email:[null,[Validators.email]],
    ...
    app_point:[null,[Validators.minLength(2),Validators.maxLength(100)]],
   ...
   // app_revenue: [null,[Validators.required,Validators.minLength(2),Validators.maxLength(100)]],
    app_profile: [null,[Validators.minLength(2),Validators.maxLength(100)]],
    app_business_line: [null,[Validators.minLength(2),Validators.maxLength(20)]],
  ...
  valider(){
    ...
    var naissance=Date.parse( ''+this.firstFormGroup.get('app_d_naissance').value)
    ...
    if(this.firstFormGroup.value.participation_conjoint=='Oui') indice_charge=2
          ...
          applicant: 
          {
            ...
            nic_image:this.firstFormGroup.value.app_profile_image,
            location:{
...
/*
 this.duree_sup=evt  
            this.thirdFormGroup.value.loan_rate=''+Number(this.thirdFormGroup.value.loan_rate? this.thirdFormGroup.value.loan_rate:0)+Number(this.duree_sup)*0.01
            let new_rate=Number(this.thirdFormGroup.value.loan_rate? this.thirdFormGroup.value.loan_rate:0)+Number(this.duree_sup)*0.01
            this.loan_rate=''+new_rate
            console.log('--------------------------------New Loan rate')
